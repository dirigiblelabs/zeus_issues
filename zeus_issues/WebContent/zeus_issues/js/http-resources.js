...
"use strict";
	...
	.service('Board', ['$resource', '$log', function($resource, $log) {
	  	return $resource('../../js/zeus_issues/svc/board.js/:boardId', { boardId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
	...
	.service('BoardComments', ['$resource', function($resource) {
	  	return $resource('../../js/zeus_issues/svc/comment.js', {}, 
	  			{get: {method:'GET', params:{}, isArray:true, ignoreLoadingBar: true}});
	}])		
	.service('$Comment', ['$resource', '$log', function($resource, $log) {
	 	return $resource('../../js/zeus_issues/svc/comment.js/:commentId', { commentId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
		                response: function(res) {
