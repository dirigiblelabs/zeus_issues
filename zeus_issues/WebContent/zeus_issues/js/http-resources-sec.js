...
"use strict";
	...
	.service('SecureBoard', ['$resource', '$log', function($resource, $log) {
	  	return $resource('../../js-secured/zeus_issues/svc/user/board.js/:boardId', { boardId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
	...
	.service('SecureBoardVote', ['$resource', function($resource) {
	  	return $resource('../../js-secured/zeus_issues/svc/user/board.js/:boardId/vote', {}, 
	...
	.service('SecureBoardTags', ['$resource', function($resource) {
	  	return $resource('../../js-secured/zeus_issues/svc/user/board.js/:boardId/tags', {}, 
	  			{
	...
	.service('$SecureComment', ['$resource', '$log', function($resource, $log) {
	 	return $resource('../../js-secured/zeus_issues/svc/user/comment.js/:commentId', { commentId:'@id' }, {
			    save: {
			        method: 'POST',
			        interceptor: {
		                response: function(res) {
	...
	.service('$LoggedUserProfile', ['$resource', function($resource) {
		var UserSvc =  $resource('../../js-secured/zeus_issues/svc/user/profile.js/logout', {}, 
	  					{get: {method:'GET', params:{}, isArray:false, ignoreLoadingBar: true}});
	  	var logout = function(){
		  	return UserSvc.get().$promise;
	  	};
