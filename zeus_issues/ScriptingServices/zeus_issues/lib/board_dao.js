...
var BoardsORM = {
	dbName: "ZEUS_ISSUES_BOARD",
	properties: [
		{
			name: "id",
			dbName: "ZEUS_ISSUESB_ID",
			id: true,
			required: true,
			type: "Long"
		},{
			name: "shortText",
			dbName: "ZEUS_ISSUESB_SHORT_TEXT",
			type: "String",
			size: 500
		},{
			name: "description",
			dbName: "ZEUS_ISSUESB_DESCRIPTION",
			type: "String",
			size: 10000
		},{
			name: "publishTime",
			dbName: "ZEUS_ISSUESB_PUBLISH_TIME",
			required: true,
			type: "Long",
			...
			dbName: "ZEUS_ISSUESB_LASTMODIFIED_TIME",
			type: "Long",
	...
	associations: [{
			name: 'comments',
			targetDao: require("zeus_issues/lib/comment_dao").get,
			joinKey: "boardId",
			type: "one-to-many",
			defaults: {
				flat:false
			...
			name: 'tagRefs',
			targetDao: require("zeus_issues/lib/board_tags_dao").get,
			joinKey: "boardId",
			type: "one-to-many"
		}, {
			name: 'tags',
			joinDao: require("zeus_issues/lib/board_tags_dao").get,
			targetDao: require("annotations/lib/tags_dao").get,
			joinKey: "boardId",
			type: "many-to-many"
		}, {
			name: 'votes',
			targetDao: require("zeus_issues/lib/board_votes_dao").get,
			joinKey: "boardId",
			type: "one-to-many"
		}]
};
