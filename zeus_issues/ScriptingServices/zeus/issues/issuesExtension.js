/*
	Extension for the '/zeus/issues/issues_database_crud_hooks' Extension Point!
...
exports.beforeCreate = function(connection, entity) {
	console.log('Before creating new entity \'' + entity + '\' in table \'ZEUS_ISSUES\'');
};

exports.afterCreate = function(connection, entity) {
	console.log('After creating new entity \'' + entity + '\' in table \'ZEUS_ISSUES\'');
};

exports.beforeUpdate = function(connection, entity) {
	console.log('Before updating table \'ZEUS_ISSUES\' with entity \'' + entity + '\'');
};

exports.afterUpdate = function(connection, entity) {
	console.log('After updating table \'ZEUS_ISSUES\' with entity \'' + entity + '\'');
};

exports.beforeDelete = function(connection, entity) {
	console.log('Before deleting entity \'' + entity + '\' from table \'ZEUS_ISSUES\'');
};

exports.afterDelete = function(connection, entity) {
	console.log('After deleting entity \'' + entity + '\' from table \'ZEUS_ISSUES\'');
};
